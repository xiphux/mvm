 ...
 *
 *  $Id: datapath.h 210 2005-10-15 04:18:35Z xiphux $
 */
...
namespace mvm
{
	namespace core
	{
		...
		private:
			...
			int temp_ID_EX_imm;
			int temp_ID_EX_Data1;
			int temp_ID_EX_Data2;
			int temp_ID_EX_op;
			struct latch_wb temp_EX_MEM_WB;
			struct latch_m temp_EX_MEM_M;
			int temp_EX_MEM_DataW;
			int temp_EX_MEM_RIS;
			int temp_EX_MEM_RegW;
			struct latch_wb temp_MEM_WB_WB;
			int temp_MEM_WB_Data;
			int temp_MEM_WB_DataR;
			int temp_MEM_WB_RegW;
